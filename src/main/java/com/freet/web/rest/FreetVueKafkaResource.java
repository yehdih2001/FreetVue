...
@RestController
@RequestMapping("/api/freet-vue-kafka")
public class FreetVueKafkaResource {

    private final Logger log = LoggerFactory.getLogger(FreetVueKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public FreetVueKafkaResource(KafkaProperties kafkaProperties) {
